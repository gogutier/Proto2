...
urlpatterns = [
    ...
    url(r'^camion_borrar/(?P<pk>\d+)$', views.objectDelete, name='delete_object'),
    ...
    url(r'^panel_movpallets_1/$',views.panel_movpallets_1,name='panel_movpallets_1'),
    url(r'^panel_movpallets_2/$',views.panel_movpallets_2,name='panel_movpallets_2'),
    ...
    url(r'^resumen_entrada_pll/$',views.resumen_entrada_pll,name='resumen_entrada_pll'),
    url(r'^busqueda_pallet_bpt/$',views.busqueda_pallet_bpt,name='busqueda_pallet_bpt'),
